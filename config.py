FORMS = {
    "1.NF- Register": {
        "form_id": "NF- Register",
        "columns": ["plot_reg-date","plot_reg-block","plot_reg-gp","plot_reg-village","plot_reg-farmer_name","plot_reg-farmer_id","plot_reg-season","plot_reg-crop_model","plot_reg-plot_gps-Latitude","plot_reg-plot_gps-Longitude","plot_reg-main_crop","plot_reg-sowing_date"],
